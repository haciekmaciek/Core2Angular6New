...
var UserComponent = /** @class */ (function () {
    function UserComponent(fb, _userService) {
        ...
        this.onProp = new core_1.EventEmitter();
        this.indLoading = false;
    }
    UserComponent.prototype.onInput = function (value) {
    ...
    UserComponent.prototype.onSubmit = function (formData) {
        ...
        switch (this.dbops) {
            case enum_1.DBOperation.create:
                this._userService.post(formData._value).subscribe(function (data) {
                    if (data == 1) {
            ...
            case enum_1.DBOperation.update:
                this._userService.put(formData._value.Id, formData._value).subscribe(function (data) {
                    if (data == 1) {
            ...
            case enum_1.DBOperation.delete:
                this._userService.delete(formData._value.Id).subscribe(function (data) {
                    if (data == 1) {
    ...
    ], UserComponent.prototype, "onProp", void 0);
    __decorate([
