...
using Core2Angular6New.Authorization;
using Core2Angular6New.Helpers;
using Core2Angular6New.ViewModels;
using Swashbuckle.AspNetCore.Swagger;
using System;
using AppPermissions = DAL.Core.ApplicationPermissions;

namespace Core2Angular6New
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.UseSqlServer(Configuration["ConnectionStrings:DefaultConnection"], b => b.MigrationsAssembly("Core2Angular6New"));
            ...
            {
                c.SwaggerDoc("v1", new Info { Title = "Core2Angular6New API", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                ...
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Core2Angular6New API V1");
            });
